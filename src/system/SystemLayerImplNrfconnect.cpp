...
#include <system/SystemLayerImplNrfconnect.h>

namespace chip {
namespace System {

LayerImplNrfconnect::LayerImplNrfconnect() : mHandlingTimerComplete(false) {}

CHIP_ERROR LayerImplNrfconnect::Init()
{
...
void LayerImplNrfconnect::Shutdown()
{
    mLayerState.ResetFromInitialized();
}

CHIP_ERROR LayerImplNrfconnect::StartTimer(Clock::Timeout delay, TimerCompleteCallback onComplete, void * appState)
{
...
CHIP_ERROR LayerImplNrfconnect::ExtendTimerTo(Clock::Timeout delay, TimerCompleteCallback onComplete, void * appState)
{
...
bool LayerImplNrfconnect::IsTimerActive(TimerCompleteCallback onComplete, void * appState)
{
    return (mTimerList.GetRemainingTime(onComplete, appState) > Clock::kZero);
}

Clock::Timeout LayerImplNrfconnect::GetRemainingTime(TimerCompleteCallback onComplete, void * appState)
{
    return mTimerList.GetRemainingTime(onComplete, appState);
}

void LayerImplNrfconnect::CancelTimer(TimerCompleteCallback onComplete, void * appState)
{
    assertChipStackLockedByCurrentThread();
...
CHIP_ERROR LayerImplNrfconnect::ScheduleWork(TimerCompleteCallback onComplete, void * appState)
{
    assertChipStackLockedByCurrentThread();
 ...
 */
CHIP_ERROR LayerImplNrfconnect::StartPlatformTimer(System::Clock::Timeout aDelay)
{
 ...
 *
 */
CHIP_ERROR LayerImplNrfconnect::HandlePlatformTimer()
{
    VerifyOrReturnError(IsInitialized(), CHIP_ERROR_INCORRECT_STATE);
