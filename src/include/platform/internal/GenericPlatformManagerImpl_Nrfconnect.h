...
class GenericPlatformManagerImpl_Nrfconnect : public GenericPlatformManagerImpl<ImplClass>
{
protected:
...
//     timeval mNextTimeout;
    ...
    explicit GenericPlatformManagerImpl_Nrfconnect(ThreadStack stack) : mChipThreadStack(stack) {}
...
extern template class GenericPlatformManagerImpl_Nrfconnect<PlatformManagerImpl>;
